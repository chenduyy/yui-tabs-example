<template>
	<view class="page-container">
		<y-tabs
			...
			@change="switchTab"
		>
			<y-tab v-for="(tab, index) in tabs" :title="tab.title" :key="index"><newsPage class="page-item" :nid="tab.newsid" :ref="'page' + index" /></y-tab>
		</y-tabs>
	</view>
</template>

<script>
import newsPage from '@/pagesYTabs/example/news/news-page';
export default {
